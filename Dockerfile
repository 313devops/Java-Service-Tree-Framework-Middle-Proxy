...
RUN wget http://www.313.co.kr/nexus/content/repositories/StandardProject/313devgrp/scouter/1.0.313/scouter-1.0.313.conf
RUN mv scouter-1.0.313.conf ./scouter.conf
